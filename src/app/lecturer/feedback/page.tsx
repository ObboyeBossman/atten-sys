...
export default async function LecturerFeedbackPage() {
  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.hero}>
        ...
        <h1 className={styles.heroTitle}>Share your perspective</h1>
        <p className={styles.heroDesc}>
          Recommend changes, highlight what works, or report issues with the attendance system. Your professional insight drives meaningful improvements.
        </p>
      </div>
      ...
      <FeedbackPageClient
        ...
        form={<FeedbackForm authorRole="lecturer" />}
