...
RETURNS uuid LANGUAGE sql IMMUTABLE AS $$
    SELECT CASE regexp_replace(trim(p_class_name), '\s+Lecturer\s*$', '', 'i')
        ...
        WHEN 'HUMAN COMPUTER INTERACTION'          THEN '00000000-0000-0000-0000-0000000000a0'::uuid
        WHEN 'JAVA PROGRAMMING'                    THEN '00000000-0000-0000-0000-0000000000a1'::uuid
        WHEN 'PRINCIPLES OF MANAGEMENT'            THEN '00000000-0000-0000-0000-0000000000a2'::uuid
        WHEN 'Data Communication'                  THEN '00000000-0000-0000-0000-0000000000a3'::uuid
        WHEN 'DATA COMMUNICATION'                  THEN '00000000-0000-0000-0000-0000000000a3'::uuid
        ELSE NULL
    END;
$$;
